...
[Export2Excel.js](https://github.com/midfar/vue3-element-admin/blob/main/src/vendor/Export2Excel.js) is packaged on the on `js-xlsx` to facilitate exporting data.
...
- [Online Code](https://github.com/midfar/vue3-element-admin/blob/main/src/views/excel/export-excel.vue)

## Excel Import

Encapsulated [UploadExcel](https://github.com/midfar/vue3-element-admin/blob/main/src/components/UploadExcel/index.vue) Excel import component, support click and drag upload, also it is also Depends on `js-xlsx`.
...
- [Online Code](https://github.com/midfar/vue3-element-admin/blob/main/src/views/excel/upload-excel.vue)
