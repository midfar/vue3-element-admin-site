...
If you don't want to use ESLint (not recommended for cancellation), just find the [vue.config.js](https://github.com/midfar/vue3-element-admin/blob/main/vue.config.js) file.
