...
> Code: [@/layout/components/Sidebar](https://github.com/midfar/vue3-element-admin/tree/main/src/layout/components/Sidebar)

This also modify many default sidebar styles of `element-ui`. All css can be found in [@/styles/sidebar.scss](https://github.com/midfar/vue3-element-admin/blob/main/src/styles/sidebar.scss) and can be modified to suit your needs.
...
::: tip unique-opened
You can set `unique-opened` in [Sidebar/index.vue](https://github.com/midfar/vue3-element-admin/blob/main/src/layout/components/Sidebar/index.vue). To control the sidebar, whether to keep only one submenu expanded.
:::

## Nested Routes

If you have a nested Route, such as [@/views/nested](https://github.com/midfar/vue3-element-admin/tree/main/src/views/nested),
...
Such as: [@/views/nested/menu1/index.vue](https://github.com/midfar/vue3-element-admin/blob/main/src/views/nested/menu1/index.vue).
...
```js
// redirect.vue
// https://github.com/midfar/vue3-element-admin/blob/main/src/views/redirect/index.vue
export default {
  beforeCreate() {
...
> Corresponding code: [@/components/Breadcrumb](https://github.com/midfar/vue3-element-admin/blob/main/src/components/Breadcrumb/index.vue)
...
::: tip Code
[@/layout/components/Sidebar](https://github.com/midfar/vue3-element-admin/blob/main/src/layout/components/Sidebar/index.vue)
:::
...
Can be set through `default-openeds`, first find [Sidebar Code](https://github.com/midfar/vue3-element-admin/blob/main/src/layout/components/Sidebar/index.vue)
