...
```js
{
  ...
  meta: { //你可以在根路由设置权限，这样它下面所有的子路由都继承了这个权限
    hidden: true, // 不在侧边栏显示
...
::: tip 代码地址
[@/layout/components/Sidebar](https://github.com/midfar/vue3-element-admin/tree/main/src/layout/components/Sidebar)
:::

这里同时也改造了 `element-ui` 默认侧边栏不少的样式，所有的 css 都可以在 [@/styles/sidebar.scss](https://github.com/midfar/vue3-element-admin/blob/main/src/styles/sidebar.scss) 中找到，你也可以根据自己的需求进行修改。
...
::: tip unique-opened
你可以在[Sidebar/index.vue](https://github.com/midfar/vue3-element-admin/blob/main/src/layout/components/Sidebar/index.vue)中设置`unique-opened`来控制侧边栏，是否只保持一个子菜单的展开。
:::
...
::: tip 代码地址
[@/components/Breadcrumb](https://github.com/midfar/vue3-element-admin/blob/main/src/components/Breadcrumb/index.vue)
:::
...
可以通过`default-openeds`来进行设置，首先找到 [侧边栏代码](https://github.com/midfar/vue3-element-admin/blob/main/src/layout/components/Sidebar/index.vue)
