...
在 `js-xlsx`的基础上又封装了[Export2Excel.js](https://github.com/midfar/vue3-element-admin/blob/main/src/vendor/Export2Excel.js)来方便导出数据。
...
- [在线代码](https://github.com/midfar/vue3-element-admin/blob/main/src/views/excel/export-excel.vue)

## Excel 导入

封装了[UploadExcel](https://github.com/midfar/vue3-element-admin/blob/main/src/components/UploadExcel/index.vue)Excel 导入组件，支持点击和拖拽上传，同样它也是依赖`js-xlsx`的。
...
- [在线代码](https://github.com/midfar/vue3-element-admin/blob/main/src/views/excel/upload-excel.vue)
